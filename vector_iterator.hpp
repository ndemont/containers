...
class vector_iterator : public iterator<random_access_iterator_tag, T>
{
	...
	public:
		...
		template <class Y>
		vector_iterator(const_vector_iterator<Y> const & x) : m_iterator(x->base()) {};
		~vector_iterator(void){};
		...
		vector_iterator operator-(difference_type n) const
		{
			return vector_iterator(m_iterator - n);
		}
		...
		template <class Y>
		friend bool operator-(const vector_iterator& lhs, const vector_iterator<Y>& rhs)
		{
...
class const_vector_iterator : public iterator<random_access_iterator_tag, T>
{
	...
	public:
		...
		const_vector_iterator operator-(difference_type n) const
		{
			return const_vector_iterator(m_iterator - n);
		}

		size_type	operator-(const const_vector_iterator& x)
		{
			return (m_iterator - x.m_iterator);
		}

		template <class Y>
		friend bool operator-(const const_vector_iterator& lhs, const const_vector_iterator<Y>& rhs)
		{
			return (lhs.m_iterator - rhs.m_iterator);
		}

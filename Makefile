...
m_uppr_bnd: init_map
			...
			@./a.out > ${RSLT_DIR}/${MAP}/upper_bound_ft && rm a.out
...
s_rel_op: init_stack
			...
			@./a.out > ${RSLT_DIR}/${STACK}/relational_operators_ft && rm a.out
